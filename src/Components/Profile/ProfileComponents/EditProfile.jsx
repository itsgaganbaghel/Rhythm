...
const EditProfile = () => {
  ...
  return (
    <div className=' shadow-[inset_5px_-5px_5px_#101215,inset_-5px_5px_5px_#424655] bg-secondary   text-light min-w-[95vw] md:max-w-[70%] md:min-w-[70%] min-h-[70vh] md:max-h-[70vh] p-10 mt-20 md:mt-0 rounded-2xl'>
