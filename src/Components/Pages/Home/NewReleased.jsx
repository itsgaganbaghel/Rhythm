        ...
        <div className='w-full min-h-[38vh] text-light  ' id='new_Release'>
            ...
            <div className='w-full flex flex-wrap justify-between px-14 relative'>
                ...
                }
                {
                    count &&
                    <NavLink to={''} state={''}
                        className="border-2 border-light flex items-center text-xl gap-3 w-[150px] rounded-full h-[150px] justify-center hover:bg-accent hover:text-primary hover:font-serif hover:font-bold hover:drop-shadow-[0px_0px_20px_rgba(135,206,235,0.7)] hover:border-accent">
                        <span>Check All</span>
